...
public class GOEvidenceCodeShadow implements GOEvidenceCode, ShadowClass
{
    ...
    @Override public String toString() { return "GOEvidenceCode [annotType=" + (annotType == null ? "null" : "\"" + annotType + "\"") + ", code=" + (code == null ? "null" : "\"" + code + "\"") + ", id=" + id + ", withText=" + (withText == null ? "null" : "\"" + withText + "\"") + "]"; }
