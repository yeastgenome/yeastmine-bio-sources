...
public class ProteinAbundanceShadow implements ProteinAbundance, ShadowClass
{
    ...
    @Override public String toString() { return "ProteinAbundance [abundance=" + abundance + ", id=" + id + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", publication=" + (publication == null ? "null" : (publication.getId() == null ? "no id" : publication.getId().toString())) + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sgdAlias=" + (sgdAlias == null ? "null" : "\"" + sgdAlias + "\"") + ", source=" + (source == null ? "null" : "\"" + source + "\"") + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", units=" + (units == null ? "null" : "\"" + units + "\"") + "]"; }
