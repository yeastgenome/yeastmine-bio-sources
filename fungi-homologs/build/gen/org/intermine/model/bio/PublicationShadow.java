...
public class PublicationShadow implements Publication, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Publication.sgdDbXrefId
    protected java.lang.String sgdDbXrefId;
    public java.lang.String getSgdDbXrefId() { return sgdDbXrefId; }
    public void setSgdDbXrefId(final java.lang.String sgdDbXrefId) { this.sgdDbXrefId = sgdDbXrefId; }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("sgdDbXrefId".equals(fieldName)) {
            return sgdDbXrefId;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("sgdDbXrefId".equals(fieldName)) {
            sgdDbXrefId = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (sgdDbXrefId != null) {
            sb.append("$_^asgdDbXrefId$_^");
            String string = sgdDbXrefId;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "asgdDbXrefId".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                sgdDbXrefId = string == null ? notXml[i] : string.toString();
                i++;
            }
